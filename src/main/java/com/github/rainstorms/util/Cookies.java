package com.github.rainstorms.util;
...
public class Cookies {
    ...
    public static Optional<Cookie> findCookie(HttpServletRequest r, String cookieName) {
        ...
        return find(cookies, cookieName, Cookie::getName);
    }
    ...
    public static void clearCookie(HttpServletResponse r, String cookieName) {
        clearCookie(r, cookieName, "");
    }
